 ...
 * @author viet7
 */
@WebServlet(name = "AddBookingServiceServlet", urlPatterns = {"/addBookingService"})
public class AddBookingServiceServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AddBookingServiceServlet</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet AddBookingServiceServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (bookingDAO.getStatusById(bookingId).equalsIgnoreCase("Confirmed") || bookingDAO.getStatusById(bookingId).equalsIgnoreCase("Checked-in")){
            ...
            response.sendRedirect("bookingroomcustomer");
        }
        else{
